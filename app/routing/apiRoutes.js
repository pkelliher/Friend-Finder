...
module.exports = function (app) {
    ...
    app.post("api/friends", function(req, res) {
        ...
        // Here we take the result of the survey POST and parse it.
        ...
        // Here we loop through all the friend possibilties in the database.
        for (var i=0; i<friends.length;i++) {
            ...
            for (var j=0;j<friends[i].scores[j];j++) {
                ...
                // If the sum of the differences is less then the differences of the current "best match"
